                    ...
                    <div id="ventasSection">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <select name="venta" id="ventaSelect" class="select2 form-select" onchange="cargarDatosVenta()">
                                ...
                                <c:forEach var="venta" items="${ventasDisponibles}">
                                    <option value="${venta.id_venta}" 
                                        ...
                                        Disponible para devolución: ${venta.cantidad_disponible}
                                        (<fmt:formatDate value="${venta.fecha_venta}" pattern="dd/MM/yyyy HH:mm:ss"/>)
                                        ${venta.cantidad_disponible <= 0 ? '- No disponible para devolución' : ''}
                                    </option>
                                </c:forEach>
                            </select>
                            <small class="text-muted">
                                Las ventas se muestran ordenadas por fecha de lote (PEPS). 
                                Las opciones deshabilitadas no tienen cantidad disponible para devolución.
                            </small>
                        </div>
                    </div>
                ...
                <div id="comprasSection" style="display:none;">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <select name="compra" id="compraSelect" class="select2 form-select" onchange="cargarDatosCompra()">
                                ...
                                <c:forEach var="compra" items="${comprasDisponibles}">
                                    <option value="${compra.id_compra}" 
                                        ...
                                        (<fmt:formatDate value="${compra.fecha_compra}" pattern="dd/MM/yyyy HH:mm:ss"/>)
                                    </option>
                                </c:forEach>
                            </select>
        ...
        <script>
                    ...
                    function cargarDatosVenta() {
                        ...
                        if (option.value) {
                            ...
                            cantidadInput.placeholder = `Máximo: ${option.dataset.cantidadDisponible} de ${option.dataset.cantidadOriginal}`;
                        }
                    }
                    ...
                    function cargarDatosCompra() {
                        ...
                        if (option.value) {
                            ...
                            const cantidadInput = document.getElementById('cantidad');
                            cantidadInput.max = option.dataset.cantidadDisponible;
                            cantidadInput.placeholder = `Disponible: ${option.dataset.cantidadDisponible} de ${option.dataset.cantidadOriginal}`;
                        }
                    }
